...
ButtonArray testButtonLookupByPoint() {
  ...
  assert(ba.getWidget(Point(0,0)) == ptr1.get());
  ...
  assert(ba.getWidget(Point(0,1)) == ptr2.get());
  ...
  assert(ba.getWidget(Point(0,2)) == ptr3.get());
  ...
  assert(ba.getWidget(Point(1,0)) == ptr4.get());
  ...
  assert(ba.getWidget(Point(1,1)) == ptr5.get());
  ...
  assert(ba.getWidget(Point(1,2)) == ptr6.get());
  ...
  assert(ba.getWidget(Point(2,0)) == ptr7.get());
  ...
  assert(ba.getWidget(Point(2,1)) == ptr8.get());
  ...
  assert(ba.getWidget(Point(2,2)) == ptr9.get());
